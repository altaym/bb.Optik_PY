...
def test():
    ...
    aAdSoyad = img[121:464,265:532]    
    aGrup = img[222:238, 130:253]
    aOgrenciNo = img[336:460, 71:192]
    aCevaplar = img[484:710, 83:535] # cevaplar 226,460

    controlArea(aCevaplar, 20, 5, 12, 11, True, 1, 5, 3)
    # controlArea(aOgrenciNo, 11, 10 , 12, 11, True)

    # img = cv.imread('1.png')
    # img = cv.resize(img,(400,600))

    # aGrup = img[380:412, 300:312]
    # aCevaplar = img[231:534, 47:96]

    # controlArea(aCevaplar, 23,4 ,12, 13)
